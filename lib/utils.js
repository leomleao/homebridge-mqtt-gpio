...
Utils.replaceHomeKitTypes = function() {
  ...
  let destDirBKP = path.normalize('../homebridge/node_modules/hap-nodejs/lib/gen/');

  let source = path.join(path.normalize('./lib/gen/'), filename);
  let destination = path.normalize('../homebridge/node_modules/hap-nodejs/lib/gen/');
