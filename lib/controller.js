...
Controller.prototype.addAccessory = function(api_accessory) {
  ...
  if (typeof name === "undefined") {
    ...
    i_accessory.addService(newAccessory, service_name, service_type, pin);
    ...
    ack = true; message = "accessory '" + name + "', service_name '" + service_name + "', wPi pin '" + pin +"' is added.";
  }
...
Controller.prototype.addService = function(api_accessory) {
  ...
  if (typeof this.hap_accessories[name] === "undefined") {
    ...
    this.accessories[name].configureAccessory(this.hap_accessories[name], api_accessory, service_name, service_type, pin);
    ...
    switch (name) {
      ...
      case "all":
        for (var k in this.accessories) {
          ...
          if (this.accessories[k].hasOwnProperty("pin")){
            accessories[k].pin = this.accessories[k].pin;
          }
        }
      break;
      ...
      default:
        ...
        if (this.accessories[name].hasOwnProperty("pin")){
          accessories[name].pin = this.accessories[name].pin;
        }
    }
...
Controller.prototype.validate = function(api_accessory) {
  ...
  return {isValid: ack, message: message, service_name: service_name, value: value, pin: pin};
}
