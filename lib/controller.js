...
Controller.prototype.addAccessory = function(api_accessory) {
  ...
  if (api_accessory.hasOwnProperty("gpio")){
    var gpio = api_accessory.gpio;
  }
  ...
  if (typeof name === "undefined") {
  ...
  } else if (typeof gpio !== "undefined" && typeof gpio.pin === "undefined") {
    ack = false; message = "pin undefined."; 
      
  } else if (typeof gpio !== "undefined" && typeof gpio.inverted !== "undefined" && typeof gpio.inverted !== "boolean") {
    ack = false; message = "inverted must be boolean."; 
    ...
    if (gpio){
      i_accessory.gpio = gpio;
      newAccessory.gpio = gpio;
    }
    ...
    ack = true; message = "accessory '" + name + "', service_name '" + service_name;
  }
    ...
    switch (name) {
      ...
      case "all":
        for (var k in this.accessories) {
          ...
          if (this.accessories[k].hasOwnProperty("gpio")){
            accessories[k].gpio = this.accessories[k].gpio;
          }
        }
      break;
      ...
      default:
        ...
        if (this.accessories[name].hasOwnProperty("gpio")){
          accessories[name].gpio = this.accessories[name].gpio;
        }
    }
...
Controller.prototype.validate = function(api_accessory) {
  ...
  // if (api_accessory.hasOwnProperty("pin")){
  //   var pin = api_accessory.pin;
  // }
  ...
  // else if (pin && typeof(pin) !== "number") {
  //   message = "pin must be set as number, not as  " + typeof(pin) + " ." ;
