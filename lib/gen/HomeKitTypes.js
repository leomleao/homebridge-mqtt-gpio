...
// THIS IS A CUSTOM VERSION OF HomeKitTypes.js, be sure to replace the file in hap-nodejs/lib/gen/HomeKitTypes.js by this one.
...
/**
 * Characteristic "GPIO Pin"
 */

Characteristic.GPIOPin = function() {
  Characteristic.call(this, 'GPIO Pin', '9fe7628a-c172-11e7-abc4-cec278b6b50a');
  this.setProps({
...
inherits(Characteristic.GPIOPin, Characteristic);

Characteristic.GPIOPin.UUID = '9fe7628a-c172-11e7-abc4-cec278b6b50a';

/**
 * Characteristic "GPIO Pin Inverted"
 */

Characteristic.GPIOPinInverted = function() {
  Characteristic.call(this, 'GPIO Pin Inverted', 'bbf59652-c174-11e7-abc4-cec278b6b50a');
  this.setProps({
...
inherits(Characteristic.GPIOPinInverted, Characteristic);

Characteristic.GPIOPinInverted.UUID = 'bbf59652-c174-11e7-abc4-cec278b6b50a';
...
Service.Lightbulb = function(displayName, subtype) {
  ...
  this.addOptionalCharacteristic(Characteristic.GPIOPin);         //Fix to add GPIO Pin
  this.addOptionalCharacteristic(Characteristic.GPIOPinInverted); //Fix to add GPIO Pin config
