...
Accessory.prototype.configureAccessory = function(accessory, api_accessory, service_name, service_type) {
  ...
  if (typeof api_accessory !== "undefined") {  // new accessory
    ...
    if (typeof api_accessory.gpio !== "undefined") { //has gpio info 
      this.gpio = api_accessory.gpio;
    }
    ...
    if (typeof accessory.gpio !== "undefined") { //has gpio info 
      this.gpio = accessory.gpio;
    }
